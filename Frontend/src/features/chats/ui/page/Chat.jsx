...
const Chat = () => {
  ...
  return (
    <div className="flex h-[calc(100vh-64px)] w-full overflow-hidden bg-[var(--background)] text-[var(--text-primary)]">
      {/* 1. Left Workspace Channels Sub-Sidebar */}
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-[var(--background)]">
        {/* Chat Channel Header */}
        <header className="px-5 py-3 border-b border-[var(--border)] bg-[var(--surface)]/80 backdrop-blur-md flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="flex flex-col min-w-0">
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 text-[10px] font-semibold rounded bg-[var(--primary-light)] text-[var(--primary)]">
                  Public Channel
                </span>
              </div>
          ...
          {messageList.length === 0 ? (
            ...
            messageList.map((message, index) => (
              <div
                ...
                className="flex items-start gap-3 group hover:bg-[var(--card-hover)]/30 p-2.5 rounded-xl transition-colors"
              >
                <div className="w-9 h-9 rounded-full bg-[var(--primary-light)] text-[var(--primary)] flex items-center justify-center font-bold text-xs shrink-0 shadow-xs border border-[var(--primary)]/20">
        ...
        {/* Message Input Box */}
        <div className="p-4 pt-0 bg-[var(--background)]">
          <form
            onSubmit={handleSendMessage}
            className="bg-[var(--surface)] rounded-xl border border-[var(--border)] focus-within:border-[var(--primary)] transition-all p-3 flex flex-col gap-2 shadow-xs"
          >
            <textarea
              rows={2}
              value={messageInput}
              ...
              className="w-full bg-transparent border-none focus:outline-none text-[var(--text-primary)] placeholder:text-[var(--text-muted)] resize-none text-sm leading-relaxed"
            />
            <div className="flex items-center justify-between pt-2 border-t border-[var(--border)]">
              ...
              <button
                type="submit"
                className="bg-[var(--primary)] hover:bg-[var(--primary-hover)] text-[var(--primary-foreground)] px-4 py-2 rounded-lg flex items-center gap-1.5 text-xs font-semibold transition-all shadow-xs cursor-pointer active:scale-95"
              >
                <span>Send</span>
          ...
          <div className="flex justify-between items-center mt-2 px-1 text-[11px] text-[var(--text-muted)]">
            <span>Pro-tip: Press Enter to send, Shift + Enter for a new line.</span>
      ...
      {/* 3. Right Sidebar: Channel About & Participants */}
