  ...
  return (
    <nav className="sticky top-0 z-20 flex h-[60px] items-center gap-3 border-b border-[var(--border)] bg-[var(--navbar)]/95 px-4 backdrop-blur sm:px-6">
      ...
      <div className="ml-auto flex items-center gap-2 sm:gap-4">
        ...
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[var(--primary)] text-xs font-bold text-white overflow-hidden shadow-xs border border-[var(--border)]">
          {avtar ? (
            <img
              src={avtar}
              alt="Avatar"
